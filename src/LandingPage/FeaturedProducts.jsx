            ...
            <div className="productsGrid" id="featuredProductsGrid">
                <div className="col">
                    <div className="card" style={{width: '18rem'}}>
                        ...
                        <div className="card-body">
                            <h3 className="card-title">Rolex 1</h3>
                ...
                <div className="col">
                    <div className="card" style={{width: '18rem'}}>
                        ...
                        <div className="card-body">
                            <h3 className="card-title">Rolex 2</h3>
                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" className="btn btn-primary">View Product</a>
                        </div>
                    </div>
                ...
                <div className="col">
                    <div className="card" style={{width: '18rem'}}>
                        ...
                        <div className="card-body">
                            <h3 className="card-title">Rolex 3</h3>
                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" className="btn btn-primary">View Product</a>
                        </div>
                    </div>
                ...
                <div className="col">
                    <div className="card" style={{width: '18rem'}}>
                        ...
                        <div className="card-body">
                            <h3 className="card-title">Rolex 4</h3>
                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" className="btn btn-primary">View Product</a>
                        </div>
                    </div>
                ...
                <div className="col">
                    <div className="card" style={{width: '18rem'}}>
                        ...
                        <div className="card-body">
                            <h3 className="card-title">Rolex 5</h3>
                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" className="btn btn-primary">View Product</a>
                        </div>
                    </div>
                ...
                <div className="col">
                    <div className="card" style={{width: '18rem'}}>
                        ...
                        <div className="card-body">
                            <h3 className="card-title">Rolex 6</h3>
                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" className="btn btn-primary">View Product</a>
                        </div>
                    </div>
